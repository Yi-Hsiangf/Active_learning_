...
class Caltech101(VisionDataset):
    ...
    def __init__(
        ...
        for (i, c) in enumerate(self.categories):
            pattern = os.path.join(self.root, "101_ObjectCategories", c, "*.jpg")
            files_in_folder = glob.glob(pattern)
            n = len(files_in_folder)
    ...
    def download(self) -> None:
        ...
        download_and_extract_archive(
            "https://syncandshare.lrz.de/dl/fiWm64Zz6XJQ63ybCRuHUNw7/101_ObjectCategories.tar.gz",
            self.root,
            filename="101_ObjectCategories.tar.gz",
            md5="b224c7392d521a49829488ab0f1120d9")
        download_and_extract_archive(
            "https://syncandshare.lrz.de/dl/fiX25qjTmZrNVWTQWcyFxwFV/Annotations.tar",
            self.root,
...
class Caltech256(VisionDataset):
    ...
    def __init__(
        ...
        self.y = []
        for (i, c) in enumerate(self.categories):
            pattern = os.path.join(self.root, "256_ObjectCategories", c, "*.jpg")
            files_in_folder = glob.glob(pattern)
            n = len(files_in_folder)
            self.index.extend(range(1, n + 1))
            self.y.extend(n * [i])
    ...
    def download(self) -> None:
        ...
        download_and_extract_archive(
            "https://syncandshare.lrz.de/dl/fiFwGqb24xTAN8iUaTspqs7p/256_ObjectCategories.tar",
            self.root,
